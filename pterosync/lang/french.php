...
$keys = [
    ...
    'SERVER_STOP_PANEL' => "ARRÊTER LE SERVEUR",
    'SERVER_KILL_PANEL' => "FORCER L'ARRÊT DU SERVEUR",
    ...
    "SERVER_KILL_PANEL_CONFIRM_MESSAGE" => "Forcer l'arrêt du serveur peut entraîner une corruption des données.",
    ...
    "SERVER_FTP_PASSWORD_INFORMATION" => "Veuillez noter que le mot de passe FTP est le même que le mot de passe que vous utilisez pour accéder au panneau de contrôle !",
    ...
    "SERVER_IS_INSTALLING" => "Le serveur est en cours d'installation"
];
