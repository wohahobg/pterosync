...
$keys = [
    'GOTO_PANEL' => "ZUM KONTROLLPANEL GEHEN",
    'QUICK_ACTIONS_PANEL' => "SCHNELLAUSWAHL",
    'SERVER_START_PANEL' => "SERVER STARTEN",
    'SERVER_RESTART_PANEL' => "SERVER NEUSTARTEN",
    'SERVER_STOP_PANEL' => "SERVER STOPPEN",
    'SERVER_KILL_PANEL' => "SERVER STOP EZWINGEN",
    "SERVER_START_PANEL_CONFIRM_MESSAGE" => "Weet u zeker dat u deze server wilt starten?",
    "SERVER_RESTART_PANEL_CONFIRM_MESSAGE" => "Weet u zeker dat u deze server opnieuw wilt starten?",
    "SERVER_STOP_PANEL_CONFIRM_MESSAGE" => "Weet u zeker dat u deze server wilt stoppen?",
    "SERVER_KILL_PANEL_CONFIRM_MESSAGE" => "Het geforceerd stoppen van de server kan leiden tot gegevenscorruptie.",
